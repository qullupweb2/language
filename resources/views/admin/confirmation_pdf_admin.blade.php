<div style="position: fixed; left: -50px; top: -50px; right: -50px; bottom: -50px; text-align: center;z-index: -1000; background-color: white; border: 2px solid green;">
    ...
    <div style="width: 70%;float:left;">
        ...
        <div style="margin-top: 150px">
            ...
            <div style="width:100%; margin-top: 20px;">
                ...
                @if($prepaid === false && $manual == false)
               
                        @if($cash)
                            Die Gebühren wurden bezahlt.
                        @else 
                            Die Gebühren wurden per Banküberweisung bezahlt.
                        @endif
                    
                @endif
                </p><br>
                <p style="text-align: left; margin:0; padding: 0; font-weight:700;font-family: Times New Roman; font-size: 18px;">Die allgemeine Geschäftsbedingungen und den Hinweis zum vorzeitigen Erlöschen des Widerrufsrechts habe ich zur Kenntnis genommen und habe es bei der Anmeldung online bestätigt
