...
Bestätigung über Anmeldung<br> zu einer Prüfung</p>
    ...
    <div style="width: 70%;float:left;">
        ...
        <h1 style="font-size: 22px">Bestätigung über Anmeldung zu einer Prüfung</h1>
        ...
        <div style="margin-top: 150px">
            ...
            <div style="width:100%; margin-top: 20px;">
                <p style="text-align: left; margin:0; padding: 0;font-family: Times New Roman; font-size: 16px;">Hiermit bestätigen wir, dass <b>{{$first_name}} {{$last_name}}</b> für <b>{{$exam_name}}</b> Prüfung am {{$date}} bei der DKH-Sprachschule eingeschrieben ist.
