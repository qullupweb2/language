<section class="content">
    ...
    <div class="container">
        ...
        @foreach($statuses as $key => $status)
            @if($status['status'] == 'payed_late')
                <div class="alert alert-warning" role="alert">Contract ID {{$key}} succefully payed but it's late<a target="_blank" href="{{$status['link_user']}}">(Show user)</a></div>
            @elseif($status['status'] == 'payed')
            ...
            @elseif($status['status'] == 'payed_again')
                <div class="alert alert-danger" role="alert">Contract ID {{$key}} succefully payed but contract already paid <a target="_blank" href="{{$status['link_user']}}">(Show user)</a></div>
