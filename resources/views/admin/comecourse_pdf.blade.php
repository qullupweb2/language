    ...
    <div style="width: 70%;float:left;">
        ...
        <div style="margin-top: 150px">
            ...
            <div style="width:100%; margin-top: 20px;">
                <p style="text-align: left; margin:0; padding: 0;font-family: Times New Roman; font-size: 16px;"><b>{{$first_name}} {{$last_name}}</b> hat an einem {{$course_name}} - Deutschkurs in der Zeit von
{{$start_date}} bis zum {{$end_date}} bei der DKH-Sprachschule
teilgenommen.
