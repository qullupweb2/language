...
<div style="padding: 20px;">
    ...
    <div style="width: 60%;float:left;">
        ...
        <div style="margin-top: 150px">
            <div>
            <p style="width:43%;text-align: left;display: inline-block; float:left; margin:0; padding: 0; font-weight:700;font-family: monospace;  font-size: 15px;">PRÄDIKAT * GRADE:</p> <p  style="width: 56%;display: inline-block;float:right;margin:0;font-family: monospace;font-size: 15px;border: 1px solid #000;border-radius: 4px;padding-top: 5px; padding-bottom:5px;text-align: center;line-height: 9px;font-weight: bold;">
...
<br>
                                                    ...
                                                    <p style="text-align: left; font-family: monospace;font-size: 12px;">
                                                        Sie können dieses Zertifikat online prüfen - https://deutsch-kurshannover.de/verify_check 
                                                    </p>
        </div>
    </div>
</div>