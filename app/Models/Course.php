...
class Course extends Model
{
    ...
    public function getPriceAttribute() {
        ...
        $difference = Dates::getDiffirenceDays($modelDate,$now);
    ...
    public function getAvailableAttribute() {
        $count = ContractItem::where('course_id', $this->id)->where('expired_at', '>', Carbon::now())->count();
    ...
    {
        $courseSerivce = new CourseService($this);
        return $courseSerivce->getManyByName($this->name);
    }
}
